 ...
 * @author user
 */
public class Add_Student_View extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public Add_Student_View() {
        initComponents();
    ...
    {
        Controll_Add_Student_1 obj = new Controll_Add_Student_1(jPanel7);
        jPanel7.addMouseListener(obj);
        Controll_Add_Student_2 obj1 = new Controll_Add_Student_2(this);
        this.jButton3.addMouseListener(obj1);
        Controll_JTextField obj_jtextfield_event = new Controll_JTextField(this, jTextField1);
        Controll_JTextField obj_jtextfield_event1 = new Controll_JTextField(this, jTextField2);
        Controll_JTextField obj_jtextfield_event2 = new Controll_JTextField(this, jTextField3);
        this.jTextField1.addMouseListener(obj_jtextfield_event);
         this.jTextField2.addMouseListener(obj_jtextfield_event1);
          this.jTextField3.addMouseListener(obj_jtextfield_event2);
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Student_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_Student_View().setVisible(true);
