 ...
 * @author user
 */
public class Add_Teacher_View extends javax.swing.JFrame {

    /**
     * Creates new form Add_Teacher_View
     */
    public Add_Teacher_View() {
        initComponents();
        setup_for_JFrame();
        add_Events();
    }
    ...
    {
        Controll_Add_Teacher1 obj = new Controll_Add_Teacher1(jPanel7);
        jPanel7.addMouseListener(obj);
        Controll_Add_Teacher2 obj1 = new Controll_Add_Teacher2(this);
        jButton3.addMouseListener(obj1);
        Controll_JTextField obj2 = new Controll_JTextField(this, jTextField1);
        Controll_JTextField obj3 = new Controll_JTextField(this, jTextField2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Teacher_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_Teacher_View().setVisible(true);
            }
        });
    }
