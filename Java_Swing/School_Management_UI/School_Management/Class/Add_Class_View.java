 ...
 */
package School_Management.Class;
 ...
 * @author user
 */
public class Add_Class_View extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public static int Flag = 0;
    public Add_Class_View() {
        initComponents();
    ...
    {
        jTextField1.addMouseListener(new Controll_JTextField(this, jTextField1));
          jTextField2.addMouseListener(new Controll_JTextField(this, jTextField2));
            jTextField4.addMouseListener(new Controll_JTextField(this, jTextField4));
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Class_View.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add_Class_View().setVisible(true);
